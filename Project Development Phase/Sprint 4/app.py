...
conn=ibm_db.connect("DATABASE=bludb;HOSTNAME=2d46b6b4-cbf6-40eb-bbce-6251e6ba0300.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;PORT=32328;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=qbj88937;PWD=8hjvhoKjyQKdJrlu;",'','')
...
def addexpense():
    ...
    if(total>limit[0]):
        ...
        print(total)
        mail_from = '19i346@psgtech.ac.in'
